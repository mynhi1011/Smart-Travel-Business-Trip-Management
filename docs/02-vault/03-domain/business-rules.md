...
| **BR-TR-02** | Phụ cấp công tác phí hàng ngày (Per Diem Allowance) | Mức công tác phí (ăn uống, đi lại nội địa) cố định khoán theo ngày: <br>• Đô thị loại 1 (Hà Nội, TP.HCM, Đà Nẵng): **400.000 VNĐ/ngày** <br>• Các tỉnh thành khác: **300.000 VNĐ/ngày** | Hệ thống tự động tính `Max_Per_Diem = Số ngày * Mức khoán`. Khi người dùng tạo hoặc submit trip với `perDiemBudget > Max_Per_Diem`, hệ thống hiển thị cảnh báo vàng/khiếu nại và vẫn cho lưu/submit; chỉ khi Manager/Travel Admin đánh giá ở bước phê duyệt thì mức vượt này được xem là blocker theo chính sách phê duyệt. | Travel Policy Standard |
