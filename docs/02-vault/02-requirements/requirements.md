...
|---|---|---|---|---|---|---|
| **REQ-TR-01** | FR | Hệ thống cho phép Employee tạo mới Trip Request gồm: Điểm xuất phát, Điểm đến, Ngày đi, Ngày về, Mục đích chuyến đi, và Dự toán chi phí. | User Research P1; Charter MVP | **Must** | Employee điền form hợp lệ và lưu nháp thành công với status `DRAFT`; sau đó submit chuyển `SUBMITTED` khi đủ điều kiện. | Confirmed |
